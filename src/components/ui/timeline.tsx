...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("group relative pb-16 pl-8 sm:pl-44", className)}
    {...props}
  />
));
...
const TimelineTime = ({
  ...
  return (
    <Badge
      className={cn(
        "left-0 mb-3 inline-flex h-12 w-36 translate-y-0.5 items-center justify-center text-xs font-semibold uppercase sm:absolute sm:mb-0",
        className
      )}
      variant={variant}
      {...props}
